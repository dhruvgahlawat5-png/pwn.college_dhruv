...
### solve
**Flag:** `pwn.college{Y2IB4-TatNE64tyNYJkpqKhnVnA.QX0YTN0wyN1gjNzEzW}`
```
hacker@piping~redirecting-output:~$ echo PWN > COLLEGE
Correct! You successfully redirected 'PWN' to the file 'COLLEGE'! Here is your 
flag:
pwn.college{Y2IB4-TatNE64tyNYJkpqKhnVnA.QX0YTN0wyN1gjNzEzW}
```
...
### solve
**Flag:** `pwn.college{0DTQRJAcZteVSivomIrJOLR_2JL.QX1YTN0wyN1gjNzEzW}`
```
...
Go for it now!
### solve
**Flag:** `pwn.college{EqFX_CphN-6cTlwJKwEUHvuwhS5.QX3ATO0wyN1gjNzEzW}`
```
...
\|/ This is the first half:
 v 
pwn.college{EqFX_CphN-6cTlwJKwEUHvuwhS5.QX3ATO0wyN1gjNzEzW}
                              ^
...
### solve
**Flag:** `pwn.college{MGeYQNRrcWLAOn9IYAeQioXOsSg.QX3YTN0wyN1gjNzEzW}`
```
...
### solve
**Flag:** `pwn.college{cRkK1_8ICkbNHdwbxuPMo1R1j0w.QXwcTN0wyN1gjNzEzW}`
```
...
Here is your flag:
pwn.college{cRkK1_8ICkbNHdwbxuPMo1R1j0w.QXwcTN0wyN1gjNzEzW}
```

## greppling stored results
...
### solve
**Flag:** `pwn.college{Y73z37y_PxXVnqcQy81vllCKGUo.QX4EDO0wyN1gjNzEzW}`
```
...
pwn.college{Y73z37y_PxXVnqcQy81vllCKGUo.QX4EDO0wyN1gjNzEzW}
```

## greppling live output
...
### solve
**Flag:** `pwn.college{kTy_-jGpK_wI8qubiH-0sry4vzy.QX5EDO0wyN1gjNzEzW}`
```
...
[PASS] Success! You have satisfied all execution requirements.
pwn.college{kTy_-jGpK_wI8qubiH-0sry4vzy.QX5EDO0wyN1gjNzEzW}
```
...
### solve
**Flag:** `pwn.college{kxZ7uvvG0voutgPEtTJ1essz5sb.QX1ATO0wyN1gjNzEzW}`
```
...
[PASS] Success! You have satisfied all execution requirements.
pwn.college{kxZ7uvvG0voutgPEtTJ1essz5sb.QX1ATO0wyN1gjNzEzW}
```
...
### solve
**Flag:** `pwn.college{AKraR55LqHIL4drPdSv5CjzvXyw.0FOxEzNxwyN1gjNzEzW}`
```
hacker@piping~filtering-with-grep-v:~$ /challenge/run | grep -v DECOY
pwn.college{AKraR55LqHIL4drPdSv5CjzvXyw.0FOxEzNxwyN1gjNzEzW}
```
...
### solve
**Flag:** `pwn.college{csZjeRemiL724PyKBF3OTba608s.0lNwMDOxwyN1gjNzEzW}`
```
hacker@piping~process-substitution-for-input:~$ diff <(/challenge/print_decoys) <(/challenge/print_decoys_and_flag)
16a17
> pwn.college{csZjeRemiL724PyKBF3OTba608s.0lNwMDOxwyN1gjNzEzW}
```
...
### solve
**Flag:** `pwn.college{M2CGC_Roz-160vKhdwj_zrcUlgU.QXwgDN1wyN1gjNzEzW}`
```
hacker@piping~writing-to-multiple-programs:~$ /challenge/hack | tee >(/challenge/the) | /challenge/planet
Congratulations, you have duplicated data into the input of two programs! Here 
is your flag:
pwn.college{M2CGC_Roz-160vKhdwj_zrcUlgU.QXwgDN1wyN1gjNzEzW}
```
...
Go get the flag!
### solve
**Flag:** `pwn.college{AHAC0QMtFtsBnNfVtbF-OF5cWey.QXxQDM2wyN1gjNzEzW}`
```
hacker@piping~split-piping-stderr-and-stdout:~$ { /challenge/hack 2>&1 1>&3 | /challenge/the; } 3>&1 | /challenge/planet
Congratulations, you have learned a redirection technique that even experts 
struggle with! Here is your flag:
pwn.college{AHAC0QMtFtsBnNfVtbF-OF5cWey.QXxQDM2wyN1gjNzEzW}
```
...
### solve
**Flag:** `pwn.college{Yp6wgP7-GFD9gAlR24JuUz9_Hvu.01MzMDOxwyN1gjNzEzW}`
```
1st terminal
hacker@piping~named-pipes:~$ ls
COLLEGE  Desktop  Downloads  PWN  a  d  f  instructions  l  myflag  o  output  pwn_output  the-flag
hacker@piping~named-pipes:~$ ls /tmp
...
pwn.college{Yp6wgP7-GFD9gAlR24JuUz9_Hvu.01MzMDOxwyN1gjNzEzW}
```
